...
Я прокинув окрему лінію яка підключена до АВР (не резервовану) і підключив до неї зарядні пристрої для заряду батарей та датчик 220в. Це потрібно щоб мати змогу моніторити наявність мережі і щоб акумулятори заряжались тільки від міської мережі.<br>
...
- Вставте отриманий текст в змінну **postData** і збережіть скрипт
- Створіть ще один скрипт з назвою **commander.be** і скопіюйте в нього текст з файлу **commander.be** в цьому репозиторії. Налаштування скриптів на цьому закінчено.
